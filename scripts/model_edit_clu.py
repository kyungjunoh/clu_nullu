...
def main(args):
    ...
    editor = HalluEditCluster(model=model, ebd=args.ebd, centering=args.centering, alpha=args.alpha,
                       top_k_ranks=args.top_k_ranks, n_clusters=args.n_clusters, edit_layer_range=layer_range, random_dps=True)
